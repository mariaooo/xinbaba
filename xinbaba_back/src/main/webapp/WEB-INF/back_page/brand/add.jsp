...
<div class="box-positon">
    ...
    <form class="ropt" id="returnBrands" action="${pageContext.request.contextPath}/upload/brand/delImg.do"
          method="post">
        ...
        <table cellspacing="1" cellpadding="2" width="100%" border="0" class="pn-ftable">
            ...
            <tr>
                ...
                <td width="80%" class="pn-fcontent">
                    ...
                    <input type="hidden" id="brandImgUrl" name="imgUrl" value="${imgUrl}"/>
                </td>
            </tr>
            <tr>
                <td width="20%" class="pn-flabel pn-flabel-h">
