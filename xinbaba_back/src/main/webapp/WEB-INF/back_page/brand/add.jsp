	      ...
	      url:'/upload/brand/addImg.do',
            ...
            success:function(data) {
	          $('#allImgUrl').attr('src',data.path);
                ...
                $('#brandImgUrl').attr('value', data.filename);
            }
        };
...
<div class="box-positon">
	...
	<form class="ropt" id="returnBrands" action="${pageContext.request.contextPath}/upload/brand/delImg.do" method="post" >
...
<div class="body-box" style="float:right">
	<form id="jvForm" action="${pageContext.request.contextPath}/brand/insertBrand.do" method="post" >
			...
			<tbody>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h"></td>
						...
						<input type="file" onchange="uploadImg()" name="pic" />
                            <input type="hidden" id="brandImgUrl" name="imgUrl"/>
					</td>
				</tr>
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
